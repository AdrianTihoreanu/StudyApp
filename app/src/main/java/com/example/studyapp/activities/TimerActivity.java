...
public class TimerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Find the ImageView element in the layout
        gifImageView = findViewById(R.id.puppy);

        // Load and display the GIF animation using Glide library
        Glide.with(this).asGif().load(R.drawable.puppy).into(gifImageView);
